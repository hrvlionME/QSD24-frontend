...
export default function Faq() {
  ...
  const handleHeadingClick = (heading: string) => {
    ...
    if (heading === "Shopping") {
      ...
      setAnswers([
        t("Yes, you can contact our customer service team via email or phone."),
      ...
      <div className={styles.container}>
        <div className={styles.heading}>
          <div
            className={
              title === "Shopping"
                ? styles.headingItemSelected
                : styles.headingItem
            }
            onClick={() => handleHeadingClick(t("Shopping"))}
          >
            <svg
              stroke="currentColor"
              fill="none"
          ...
          <div
            ...
            onClick={() => handleHeadingClick(t("Receiving shipment"))}
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <div
            ...
            onClick={() => handleHeadingClick("Return of Goods")}
          >
            <svg
              viewBox="0 0 512 512"
              fill="currentColor"
          ...
          <div
            ...
            onClick={() => handleHeadingClick("Complaint")}
          >
            <svg
              fill="none"
              stroke="currentColor"
            ...
            return (
              ...
              >
                <div style={{ display: "flex" }}>
                  <span
                    className={
                      isExpanded ? styles.questionExpanded : styles.question
                    }
                  >
                ...
                {isExpanded && (
                  <span className={styles.answer}>{answers[index]}</span>
                )}
              </div>
            );
          })}
        ...
        <div className={styles.footer}>
          <span>{t("missing_information")}</span>
          <span>
            {t("contact_service")} hello@qsd.ba, {t("contact_directly")}
