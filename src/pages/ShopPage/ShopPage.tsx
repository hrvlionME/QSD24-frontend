  ...
  return (
    <>
      <div className={styles.page}>
        {showFilter && <Filter />}
        {showFilter && window.innerWidth <= 768 && <div className={styles.blockContent} onClick={() => setShowFilter(false)}></div>}
        <div className={styles.content}>
          ...
          <div className={styles.cards}>
            <div className={styles.text}>There are no products in this category.</div>
          </div>
        </div>
      </div>
      <Footer />
